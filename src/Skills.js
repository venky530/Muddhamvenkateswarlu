...
const skills = [
  { name: 'Terraform', percentage: 80, color: '#61dafb' },
  { name: 'Kubernetes', percentage: 75, color: '#653e00' },
  { name: 'Docker', percentage: 85, color: '#2965f1' },
  { name: 'Jenkins', percentage: 85, color: '#f7df1e' },  
