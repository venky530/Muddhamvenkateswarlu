      ...
      <div className="work-experience">
        ...
        <div className="achievements">
          ...
          <ul className="achievements-list">
            ...
            <li>
              <i className="fas fa-check-circle"></i> Led a team in multiple
              projects, overseeing development efforts, providing technical
              guidance, and ensuring timely delivery.
            </li>
            <li>
            ...
            <li>
              <i className="fas fa-check-circle"></i> Led the development of
              multiple single-page applications (SPAs), ensuring a seamless user
            ...
            <li>
              <i className="fas fa-check-circle"></i> Participated in code
              reviews, providing constructive feedback to uphold code quality
              and best practices.
            </li>
          </ul>
        </div>
